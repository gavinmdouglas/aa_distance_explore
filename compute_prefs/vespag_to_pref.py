...
from functions import vespag_dir_to_prefs
...
def main():
    parser = argparse.ArgumentParser(
        ...
        description='''
            Parse directory of VespaG output files to amino acid preference tables.
            ''',

        formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument('-i', '--input',
                        help='Input folder of VespaG output CSVs (gzipped).',
                        required=True,
                        metavar='DIR',
                        type=str)
    ...
    vespag_dir_to_prefs(in_dir=args.input,
                        out_dir=args.out_folder,
                        all_sites_present=not args.all_sites_not_present,
                        ref_aa_file=args.aa_ref,
