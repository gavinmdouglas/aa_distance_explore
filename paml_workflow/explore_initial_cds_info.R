...
mammal <- read.table("/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/OrthoMaM_seq_info.tsv",
                     header=TRUE, sep = '\t')

fly <- read.table("/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/Drosophila_all_cds_seq_info.tsv",
                     header=TRUE, sep = '\t')

Strep <- read.table("/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/Streptococcus_seq_info.tsv",
                     header=TRUE, sep = '\t')
...
write.table(x = gsub('_NT_AL$', '', mammal$name),
            file = '/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/filt_ids/orthomam_filt_ids.txt',
            quote = FALSE, sep = '\t', row.names = FALSE, col.names = FALSE)

write.table(x = gsub('.DNA.afa$', '', fly$name),
            file = '/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/filt_ids/drosophila_filt_ids.txt',
            quote = FALSE, sep = '\t', row.names = FALSE, col.names = FALSE)

write.table(x = gsub('_final_mask_align_NT$', '', Strep$name),
            file = '/Users/gavin/Drive/research/aa_distance/aa_distance_zenodo/PAML_workflow/initial_seq_info/filt_ids/streptococcus_filt_ids.txt',
            quote = FALSE, sep = '\t', row.names = FALSE, col.names = FALSE)
